...
class ServiceStub {
    constructor(service) {
        ...
        this.getQueryStringStub = sinon.stub(service.queryUtils, 'getQueryString').returns('stub string');
        this.setDefaultFiltersStub = sinon.stub(service.queryUtils, 'setDefaultFilters').returns('stub filters');
    }
