...
export const FRESHTRAK_API_HOST =
  process.env.FRESHTRAK_API_HOST || 'https://pantry-finder-api.freshtrak.com';

export const FRESHTRAK_ZIP_URL =
  process.env.FRESHTRAK_ZIP_URL || 'https://freshtrak.com/events/list/';

export const FRESHTRAK_AGENCY_URL =
  process.env.FRESHTRAK_AGENCY_URL || 'https://freshtrak.com/agency/events/';
